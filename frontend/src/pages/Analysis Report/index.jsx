...
const AnalysisReport = () => {
  ...
  return (
    // Responsive container: adjusts padding and margins for different screen sizes
    <div className="max-w-4xl mx-auto my-4 sm:my-10 p-4 sm:p-6 md:p-10 bg-white rounded-2xl shadow-lg font-sans text-gray-800">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4 flex items-center">
            <span className="text-green-500 mr-2 text-2xl">✅</span> Beneficial
            Ingredients
          </h2>
      ...
      {/* Footer */}
      <footer className="text-center text-xs text-gray-400 mt-10 border-t border-gray-200 pt-6">
        © {new Date().getFullYear()} MedAlert. All rights reserved.
      </footer>
    </div>
  );
};
